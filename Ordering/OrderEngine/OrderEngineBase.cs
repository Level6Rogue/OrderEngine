...
public abstract class OrderEngineBase : IOrderEngine
{
    ...
    protected readonly List<NodeEntry> Nodes = [];
    ...
    protected abstract class ItemEntry(string path, string name)
    {
    ...
    protected sealed class ElementEntry(string path, string name, string? parentGroupPath, int nodeId)
        : ItemEntry(path, name)
    {
        public string? ParentGroupPath { get; } = parentGroupPath;
        public int NodeId { get; } = nodeId;
    }

    protected sealed class GroupEntry(string path, string name, string? parentPath, int startNodeId, int endNodeId)
        : ItemEntry(path, name)
    {
        public string? ParentPath { get; } = parentPath;
        public int StartNodeId { get; } = startNodeId;
        public int EndNodeId { get; } = endNodeId;
