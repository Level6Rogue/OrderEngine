...
namespace L6R.OrderEngine.Benchmarks;
...
public class OrderEngineBenchmarks
{
    ...
    public void Setup()
    {
        ...
        _flatEngineForAddCached = OrderEngineFactory.Create(BuildMode.MultipleBuild);
        ...
        _flatEngineForAddSimplified = OrderEngineFactory.Create(BuildMode.SingleBuild);
    ...
    {
        IOrderEngine engine = OrderEngineFactory.Create(mode);
